...
public class DepartmentAddServlet extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         request.setAttribute("message", "Add new department");
        request.getRequestDispatcher("departmentAddPage.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (DepartmentValidator.checkDepartmentNameOnUnike(department.getName())!=(-1)){
                ...
                request.setAttribute("message", "Departent added!");
                response.sendRedirect("departmentslist?message=Departent added!");
            }
